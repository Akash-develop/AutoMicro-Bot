        ...
        <div className="input-bar-container">
            ...
            {selectedFile && (
                <div className="d-flex align-items-center gap-2 mb-2 animate-fade-in" style={{ width: 'fit-content' }}>
                    <div 
                        className="d-flex align-items-center gap-2 px-2 py-1.5 rounded-pill shadow-sm position-relative group"
                    ...
                    >
                        ...
                        <span style={{ fontSize: '11px', maxWidth: '120px', color: 'var(--text-main)', opacity: 0.9 }}>{selectedFile.name}</span>
                            <button 
                                onClick={() => setSelectedFile(null)}
                                className="btn btn-link p-0 d-flex align-items-center justify-content-center opacity-40 hover-opacity-100"
                                style={{ width: '14px', height: '14px', border: 'none', color: 'var(--text-main)' }}
                            >
            ...
            <div className="d-flex align-items-center gap-2 position-relative">
                ...
                <button 
                    ...
                    className="btn btn-link p-0 d-flex align-items-center justify-content-center flex-shrink-0 transition-all" 
                    style={{ width: '38px', height: '38px', background: 'var(--input-bg)', borderRadius: '12px', border: 'none', color: 'var(--text-secondary)' }}
                >
                ...
                {/* Pill Input Container */}
                    ...
                    <textarea
                        ...
                        rows={1}
                        disabled={disabled}
                        className="flex-grow-1 bg-transparent border-0 outline-none py-2"
                        style={{ fontSize: '13px', resize: 'none', maxHeight: '120px', color: 'var(--text-main)' }}
                    />
                </div>
                ...
                <button
                    ...
                    style={{ 
                        ...
                        height: '38px', 
                        borderRadius: '12px',
                        background: disabled ? 'rgba(239, 68, 68, 0.2)' : ((value.trim() || selectedFile) ? 'var(--accent)' : 'var(--input-bg)'),
                        color: disabled ? '#f87171' : 'var(--text-main)',
